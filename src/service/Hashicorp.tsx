const certifications = {
    fundamentals: {
      title: "Fundamentals",
      bgColor: "bg-[#7b42bc]", // Azure Blue
      cards: [
        {
          title: "CNCF Kubernetes and Cloud-Native Associate",
          description:
            "When you're new to Cloud-Native and Kubernetes.",
          difficulty: "Medium",
          duration: "2-3 weeks",
        },
  ...
  import logo from "../assets/hashicorp-logo.svg";
  ...
  return (
    <div className="px-4 py-12 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-8">
        ...
        Kubernetes is the industry standard for orchestration of cloud-native applications running in containers. Kubernetes can run on any cloud provider and most cloud-native software is built onto of Kuberenetes.</p>
      </div>
                ...
                <div className="flex items-center justify-between w-full mt-auto pt-4 border-t border-gray-200">
                  ...
                  <button
                    className={`py-2 px-4 text-sm rounded-full text-white font-semibold ${
                      value.title === "Foundational" ? "bg-[#2E3E50]" : "bg-[#7b42bc]"
                    }`}
                  >
                    Learn More
                  </button>
